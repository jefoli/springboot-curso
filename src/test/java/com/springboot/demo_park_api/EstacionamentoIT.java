package com.springboot.demo_park_api;
...
public class EstacionamentoIT {
    ...
    @Test
    public void criarChekin_ComDadosInvalidos_RetornarErrorStatus422() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("").marca("").modelo("")
                .cor("").clienteCpf("")
                .build();
    ...
    public void criarChekin_ComCpfInexistente_RetornarErrorStatus404() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("33838667000") //CPF NÃO EXISTE NO DB - causa do erro
                .build();
    ...
    public void criarChekin_ComVagasOcupadas_RetornarErrorStatus404() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("09191773016") //CPF NÃO EXISTE NO DB - causa do erro
                .build();
    ...
    @Test
    public void buscarChekin_ComPerfilAdmin_RetornarDadosStatus200() {
    ...
    @Test
    public void buscarChekin_ComPerfilCliente_RetornarDadosStatus200() {
    ...
    @Test
    public void buscarChekin_ComReciboInexistente_RetornarErrorStatus404() {

        testClient.get()
                .uri("/api/v1/estacionamentos/check-in/{recibo}", "20230313-000000")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    @Test
    public void criarCheckOut_ComReciboInexistente_RetornarErrorSatus404() {
    ...
    @Test
    public void criarCheckOut_ComRoleCliente_RetornarErrorSatus403() {
    ...
    @Test
    public void buscarEstacionamento_PorClienteCpf_RetornarSucesso200() {
    ...
    @Test
    public void buscarEstacionementos_PorClienteCpfComPerfilCliente_RetornarErrorStatus403() {
    ...
    @Test
    public void buscarEstacionamento_DoClienteLogado_RetornarSucesso200() {
    ...
    @Test
    public void buscarEstacionementos_DoClienteLogadoPerfilAdmin_RetornarErrorStatus403() {
