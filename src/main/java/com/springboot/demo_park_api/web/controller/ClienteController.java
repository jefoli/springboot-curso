...
public class ClienteController {
    ...
    @Operation(summary = "Localizar um cliente",
            ...
            "requsição exige uso de um bearer token. Acessos restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            responses = {
    ...
    @Operation(summary = "Recuperar lista de clientes",
        ...
        parameters = {
            ...
            @Parameter(in = QUERY, name = "size",
                    ...
                    description = "Representa o total dos elementos por página"
            ),
            @Parameter(in = QUERY, name = "sort", hidden = true, //hidden nao adiciona na url a instrucao "esconde da doc"
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "403", description = "Recurso não permitido ao perl de CLIENTE",
                content = @Content(mediaType = " application/json;charset=UTF-8",
